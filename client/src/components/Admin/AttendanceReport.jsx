    ...
    return (
        <div className='flex'>
            ...
            <div className='md:w-[80%] w-[70%] h-fit'>
                ...
                <div className='p-5'>
                    <h1 className='md:text-xl text-sm font-bold'>Attendance Report</h1>
                    <p className='text-sm my-2'>Management <span className='font-bold text-sm'><i class="fa-solid fa-greater-than "></i></span> Attendance Report </p>
                </div>
            </div>
        </div>
    )
