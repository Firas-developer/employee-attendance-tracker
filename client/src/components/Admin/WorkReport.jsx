    ...
    return (
        <div className='flex'>
            <div className='bg-gray-800 text-gray-300 w-[30%] text-sm md:text-l md:w-[20%] h-[100vh] md:p-5 p-3'>
                ...
                <hr className='text-white md:mt-5 my-2' />
                <h1 className='tmd:text-[80%] text-[70%] font-serif font-semibold'>WORK</h1>
            ...
            <div className='md:w-[80%] w-[70%] h-fit'>
                ...
                <div className='p-5'>
                    <h1 className='md:text-xl text-sm font-bold'>Work Report</h1>
                    <p className='text-sm my-2'>Work <span className='font-bold text-sm'><i class="fa-solid fa-greater-than "></i></span> Work Report </p>
                </div>
