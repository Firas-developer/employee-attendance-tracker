        ...
        <div className='flex'>
            ...
            <div className='md:w-[80%] w-[70%] h-fit'>
                <div className='shadow-xl p-3 shadow-gray-200 items-center flex justify-between '>
                    ...
                    <p className='font-semibold text-[80%] md:text-[100%]'>Employee</p>
                </div>
                <div>
                    <h1 className='m-5 font-bold text-sm md:text-xl'>ATTENDANCE</h1>
                    <p className='m-5 text-sm'>Management <span className='font-bold text-sm'><i class="fa-solid fa-greater-than "></i></span> Mark Attendance </p>
                </div>
